...
@dag(schedule_interval='*/5 * * * *', default_args=default_args, start_date=datetime(2023, 10, 14), catchup=False,
     tags=["slack_alerts"], description='DAG for sending slack alert for live BBL markets')
