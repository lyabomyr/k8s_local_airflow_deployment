...
spark = (
    ...
    .config(
        "spark.jars.packages",
        "org.apache.hadoop:hadoop-aws:3.3.2,io.delta:delta-spark_2.12:3.1.0",
    )
...
spark.read.format("parquet").load("s3a://data/some_data1").createOrReplaceTempView(
    "some_data1"
)
spark.read.format("parquet").load("s3a://data/some_data2").createOrReplaceTempView(
    "some_data2"
)
