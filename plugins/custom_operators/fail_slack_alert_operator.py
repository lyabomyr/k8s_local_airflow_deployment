...
def task_fail_slack_alert(context, slack_webhook_url=os.getenv('SLACK_AIRFLOW_WEB_HOOK')) -> str:
    slack_msg = {
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            logging.error(f"Failed to send Slack alert. Status code: {response.status_code}")
